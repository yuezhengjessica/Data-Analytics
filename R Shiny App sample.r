...
#source('C:/User/YZheng/OneDrive - Imperial Bag and Paper/Yue Zheng Jessica/R App/Export ten Dade Reports by Cust-Item Sales and Margin-Run Every Day.R',echo=TRUE)
